...
public partial class App : Application
{
	...
	public override void OnFrameworkInitializationCompleted()
	{
		if (ApplicationLifetime is IClassicDesktopStyleApplicationLifetime desktop)
		{
			...
			appServices.AddSingleton<IAudioEngineService, SoundFlowAudioEngineService>();
			appServices.AddSingleton<IPlaybackSubsystem, LocalPlaybackSubsystem>();
			appServices.AddSingleton<IPlaylistSerializer, JsonPlaylistSerializer>();
